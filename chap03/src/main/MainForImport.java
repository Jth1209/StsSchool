...
public class MainForImport {
	...
	public static void main(String[] args) throws IOException {
		...
		ctx = new AnnotationConfigApplicationContext(AppConf1.class,AppConf2.class);//AppCtx클래스를 컨테이너로 만듬 ==> 그래야 안에 있는 Bean 애노테이션을 사용할 수 있음
	...
	private static void processNewCommand(String[] arg) {
		...
		MemberRegisterService regSvc = ctx.getBean("memberRegSvc",MemberRegisterService.class);//ctx.getBean메소드를 이용해서 초기화
	...
	private static void processChangeCommand(String[] arg) {
		...
		ChangePasswordService changePwdSvc = 
				ctx.getBean("changePwdSvc",ChangePasswordService.class);//ctx.getBean메소드를 이용해서 초기화
		try {
